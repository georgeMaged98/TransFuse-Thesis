...
//   auto pos = fifo_queue.end();
//   for (auto it = this->fifo_queue.begin(); it != this->fifo_queue.end(); ++it) {
//      const auto bf = this->hashtable[*it].get();
//      if (bf != nullptr && bf->num_fixed == 0 && !bf->is_dirty) {
//         evicted_page_id = *it;
//         pos = it;
//         break;
//      }
//      if (bf != nullptr && bf->num_fixed == 0) {
//         evicted_page_id = *it;
//         pos = it;
//      }
//   }
//   if (evicted_page_id != -1 && pos != fifo_queue.end()) {
