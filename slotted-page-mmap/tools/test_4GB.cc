...
static std::string sp_name = "/tmp/transfuse_mnt/4GB_sp.txt";
static std::string fsi_name = "/tmp/transfuse_mnt/4GB_fsi.txt";
static std::string schema_name = "/tmp/transfuse_mnt/4GB_schema.txt";
static std::string wal_name = "/tmp/transfuse_mnt/4GB_wal.txt";
static std::string log_file_name = "transfuse_hot_cold_operations_4GB_";



// static std::string sp_name = "4GB_sp.txt";
// static std::string fsi_name = "4GB_fsi.txt";
// static std::string schema_name = "4GB_schema.txt";
// static std::string wal_name = "4GB_wal.txt";

constexpr static uint64_t mmapSize = 4ULL * 1024 * 1024 * 1024;

// constexpr static uint64_t max_num_records = 83886080; // For Reference
